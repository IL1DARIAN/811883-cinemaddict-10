export const createFilmCardTemplate = (filmCard) => {
  const {filmCardTitle, filmCardRating, filmCardYear, filmCardDurationHours, filmCardDurationMinutes, filmCardGenre, filmCardPoster, filmCardDescription, filmCardComment} = filmCard;
  ...
  return (
    `<article class="film-card">
      ...
      <a class="film-card__comments">${filmCardComment} комментариев</a>
